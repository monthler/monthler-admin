...
INSERT INTO gov_notice VALUES(3, NOW(), NOW(), '장항', '장항 워케이션 참가자 모집', 'janghang@naver.com', '장항 워케이션 모집 합니다.', 10, 20, 1, 100, 'http://janghang.com', '010-9999-8888', NOW(), NOW(), 3, '관련파일 url3', '그외', NOW(),  NOW(), NOW(), 100000, '장항에서 일해보자!', 'Y', 1);
